...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var postsLabel: UILabel = {
        ...
        label.attributedText = attributedStartText(value: 1, label: "poste")
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        let buttonStack = UIStackView(arrangedSubviews: [gridButtonButton, listButton, bookmarkButton])
